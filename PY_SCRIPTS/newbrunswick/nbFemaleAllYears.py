#!/usr/bin/env python3
#./PY_SCRIPTS/newbrunswick/nbFemaleAllYears.py -i NB.csv -o OUTPUTS/NBfemaleAllYears
...
def main(argv):
    ...
    if len(argv) < 4:
        print(
        "Usage: ./PY_SCRIPTS/newbrunswick/nbFemaleAllYears.py -i <input file name> -o <output file name base>"
        )
        sys.exit(2)
    try:
