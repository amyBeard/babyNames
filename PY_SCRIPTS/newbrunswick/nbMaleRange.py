...
#./PY_SCRIPTS/newbrunswick/nbMaleRange.py -i NB.csv -1 <year1> -2 <year2> -o OUTPUTS/nbMale 
...
def main(argv):
    ...
    if len(argv) < 7:
        print(
        "Usage: ./PY_SCRIPTS/newbrunswick/nbMaleRange.py -i <input file name> -1 <year1> -2 <year2> -o <output file name base>"
        )
        sys.exit(2)
    try:
