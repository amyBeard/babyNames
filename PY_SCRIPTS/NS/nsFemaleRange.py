#!/usr/bin/env python3
#chmod 777 PY_SCRIPTS/NS/nsFemaleRange.py
#./PY_SCRIPTS/newbrunswick/nbFemaleRange.py -i NS.csv -1 <year1> -2 <year2> -o OUTPUTS/nbFemale 
...
def main(argv):
    ...
    if len(argv) < 7:
        print(
        "Usage: ./PY_SCRIPTS/NS/nsFemaleRange.py -i <input file name> -1 <year1> -2 <year2> -o <output file name base>"
        "!!!"
        )
        sys.exit(2)
    try:
