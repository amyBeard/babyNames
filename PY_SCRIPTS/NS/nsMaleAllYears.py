#!/usr/bin/env python3
#chmod 777 ./PY_SCRIPTS/NS/nsMaleAllYears.py
#./PY_SCRIPTS/NS/nsMaleAllYears.py -i NS.csv -o OUTPUTS/NSmaleAllYears
...
def main(argv):
    ...
    if len(argv) < 4:
        print(
        "Usage: ./PY_SCRIPTS/NS/nsMaleAllYears.py -i <input file name> -o <output file name base>"
        )
        sys.exit(2)
    try:
